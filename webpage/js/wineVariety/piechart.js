...
class PieChart {
    ...
    wrangleData(){
        let vis = this
        vis.displayData = vis.varietyData.filter(function (d) {return d.variety == selectedCategory})

        let tempData = vis.wordData.filter(function (d) {return d.variety == selectedCategory})
